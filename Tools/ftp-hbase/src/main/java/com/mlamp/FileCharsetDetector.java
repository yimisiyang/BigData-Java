...
public class FileCharsetDetector {
    ...
    public static void main(String[] argv) throws Exception {
        File file1 = new File("C:\\Users\\MeSweet\\Desktop\\temp\\diyxq - 副本.txt");
    ...
    public String guessFileEncoding(InputStream ins) throws FileNotFoundException,IOException{
        return guessFileEncoding(ins,new nsDetector());
    }
     ...
     *  </pre>
     *
     * @return 文件编码，eg:UTF-8,GBK,GB2312形式（不确定的时候，返回可能的字符编码序列；若无返回null）
     * @throw FileNotFoundException
     * @throws IOException
     */
    ...
    private String guessFileEncoding(File file, nsDetector det) throws FileNotFoundException,IOException{
        ...
        if(!found){
            ...
            if(prob.length > 0){
                //在没有发现情况下，也可以只读第一个可能的编码，这里返回的是一个可能的序列
                return encoding;
            }else{
                return null;
            }
    ...
    private String guessFileEncoding(InputStream ins, nsDetector det) throws FileNotFoundException, IOException {
        det.Init(new nsICharsetDetectionObserver() {
            @Override
            public void Notify(String charset) {
                encoding = charset;
